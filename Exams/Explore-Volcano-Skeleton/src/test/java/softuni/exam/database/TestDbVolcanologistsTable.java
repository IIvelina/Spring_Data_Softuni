...
//
//@DataJpaTest
//public class TestDbVolcanologistsTable {
//
//    @Autowired
...
//
//    @Test
//    void testVolcanologistsTable() throws SQLException {
//        DatabaseMetaData metaData = getDatabaseMetaData();
//        List<String> expectedResult = new ArrayList<>();
//        expectedResult.add("ID,BIGINT,0,19,19");
//        expectedResult.add("AGE,INTEGER,0,10,10");
//        expectedResult.add("EXPLORING_FROM,DATE,1,10,10");
...
//        expectedResult.add("EXPLORING_VOLCANO_ID,BIGINT,1,19,19");
//
//
//        ResultSet columns = metaData.getColumns(null, "PUBLIC", "VOLCANOLOGISTS", null);
//
