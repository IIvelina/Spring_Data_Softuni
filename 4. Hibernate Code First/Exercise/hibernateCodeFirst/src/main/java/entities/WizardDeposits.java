...
public class WizardDeposits {
    ...
    public WizardDeposits(String firstName, String lastName, String notes, int age, String magicWandCreator, long magicWandSize, String depositGroup, Date depositStartDate, double depositAmount, double depositInterest, double depositCharge, Date depositExpirationDate, boolean isDepositExpired) {
